                        ...
                        <div class="spp-bento-card md:col-span-5 md:row-span-2">
                            <div class="spp-bento-pad">
                                <div class="spp-bento-media aspect-[16/9]">
                                    <img src="{{ asset('img/processimg3.webp') }}" alt="Document Delivery, Marketing, and Closing" class="w-full h-full object-cover" data-fallback="{{ asset('img/processimg2.png') }}" onerror="this.onerror=null; this.src=this.dataset.fallback;">
                                </div>
