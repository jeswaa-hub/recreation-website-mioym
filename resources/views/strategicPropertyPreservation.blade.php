    ...
    <main class="pt-16 lg:pt-20">
        ...
        <section class="bg-black">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
                ...
                <div class="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto">
                    
                    <!-- Left Column -->
                    <div class="flex flex-col gap-6 lg:gap-8">
                        <!-- Card 1: Property Preservation Services -->
                        <div class="flex flex-col p-8 lg:p-10 bg-[#787878]/90 border border-white/10 shadow-[0_30px_70px_rgba(0,0,0,0.35)] h-[380px] lg:h-[420px] transform hover:-translate-y-2 transition-transform duration-300 rounded-tl-[14px] rounded-tr-[100px] rounded-br-[14px] rounded-bl-[100px]">
                            <h3 class="text-2xl font-extrabold text-white mb-6 leading-snug tracking-tight" style="font-family: 'Plus Jakarta Sans', sans-serif;">Property<br>Preservation<br>Services</h3>
                            <p class="text-sm lg:text-[0.9rem] leading-relaxed text-white/85" style="font-family: 'Inter', sans-serif;">
                        ...
                        <!-- Card 2: Insurance Loss -->
                        <div class="flex flex-col p-8 lg:p-10 bg-[#787878]/90 border border-white/10 shadow-[0_30px_70px_rgba(0,0,0,0.35)] h-[380px] lg:h-[420px] transform hover:-translate-y-2 transition-transform duration-300 rounded-tl-[14px] rounded-tr-[100px] rounded-br-[14px] rounded-bl-[100px]">
                            <h3 class="text-2xl font-extrabold text-white mb-6 leading-snug tracking-tight" style="font-family: 'Plus Jakarta Sans', sans-serif;">Insurance Loss and<br>FEMA Inspections</h3>
                            <p class="text-sm lg:text-[0.9rem] leading-relaxed text-white/85" style="font-family: 'Inter', sans-serif;">
                    ...
                    <!-- Middle Column (Pushed down for zigzag) -->
                    <div class="flex flex-col gap-6 lg:gap-8 mt-0 lg:mt-24">
                        <!-- Card 3: Inspection Services -->
                        <div class="flex flex-col p-8 lg:p-10 bg-[#787878]/90 border border-white/10 shadow-[0_30px_70px_rgba(0,0,0,0.35)] h-[380px] lg:h-[420px] transform hover:-translate-y-2 transition-transform duration-300 rounded-tl-[100px] rounded-tr-[14px] rounded-br-[100px] rounded-bl-[14px]">
                            <h3 class="text-2xl font-extrabold text-white mb-6 leading-snug tracking-tight" style="font-family: 'Plus Jakarta Sans', sans-serif;">Inspection Services<br>Tailored to Your<br>Needs</h3>
                            <p class="text-sm lg:text-[0.9rem] leading-relaxed text-white/85" style="font-family: 'Inter', sans-serif;">
                        ...
                        <!-- Card 4: Property Valuations -->
                        <div class="flex flex-col p-8 lg:p-10 bg-[#787878]/90 border border-white/10 shadow-[0_30px_70px_rgba(0,0,0,0.35)] h-[380px] lg:h-[420px] transform hover:-translate-y-2 transition-transform duration-300 rounded-tl-[100px] rounded-tr-[14px] rounded-br-[100px] rounded-bl-[14px]">
                            <h3 class="text-2xl font-extrabold text-white mb-6 leading-snug tracking-tight" style="font-family: 'Plus Jakarta Sans', sans-serif;">Property<br>Valuations</h3>
                            <p class="text-sm lg:text-[0.9rem] leading-relaxed text-white/85" style="font-family: 'Inter', sans-serif;">
                    ...
                    <!-- Right Column -->
                    <div class="flex flex-col gap-6 lg:gap-8">
                        <!-- Card 5: Loss Mitigation -->
                        <div class="flex flex-col p-8 lg:p-10 bg-[#787878]/90 border border-white/10 shadow-[0_30px_70px_rgba(0,0,0,0.35)] h-[380px] lg:h-[420px] transform hover:-translate-y-2 transition-transform duration-300 rounded-tl-[14px] rounded-tr-[100px] rounded-br-[14px] rounded-bl-[100px]">
                            <h3 class="text-2xl font-extrabold text-white mb-6 leading-snug tracking-tight" style="font-family: 'Plus Jakarta Sans', sans-serif;">Loss Mitigation<br>Expertise</h3>
                            <p class="text-sm lg:text-[0.9rem] leading-relaxed text-white/85" style="font-family: 'Inter', sans-serif;">
                        ...
                        <!-- Card 6: REO Management -->
                        <div class="flex flex-col p-8 lg:p-10 bg-[#787878]/90 border border-white/10 shadow-[0_30px_70px_rgba(0,0,0,0.35)] h-[380px] lg:h-[420px] transform hover:-translate-y-2 transition-transform duration-300 rounded-tl-[14px] rounded-tr-[100px] rounded-br-[14px] rounded-bl-[100px]">
                            <h3 class="text-2xl font-extrabold text-white mb-6 leading-snug tracking-tight" style="font-family: 'Plus Jakarta Sans', sans-serif;">REO<br>Management</h3>
                            <p class="text-sm lg:text-[0.9rem] leading-relaxed text-white/85" style="font-family: 'Inter', sans-serif;">
